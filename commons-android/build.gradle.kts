...
dependencies {
    ...
    // On-device wake-word detection (OwwRecognizer/WakeMicEngine) via openWakeWord — free, keyless,
    // offline, no GMS. Models are bundled (assets/oww/*.onnx); no runtime download.
